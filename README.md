...
Basicamente o usuário terá que entrar com o usuário/repositório no campo apropriado e em seguida clicar em pesquisar ou precionar "Enter". Se o repositório for existente, será exibido uma miniatura da foto do criador + descrição do repositório. Caso haja alguma informação inserida equivocadamente ou autor/repositório não existente, será exibido um alerta para revisão.

Ao clicar no respectivo repositório, será exibido dados básicos como a quantidade de Stars, Forks e Issues que o repositório possui. Listando também as issues do projeto.
